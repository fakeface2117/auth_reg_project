...
@products_router.post(path='/add', summary="Добавление админом одного товара")
...
@products_router.post(path='/add-many')
@admin_verified
...
@products_router.get(path='/all-briefly')
...
@products_router.get(path='/{product_id}')
...
@products_router.post(path='/filter')
async def products_by_filter(
...
@products_router.patch(path='/{product_id}')
@admin_verified
